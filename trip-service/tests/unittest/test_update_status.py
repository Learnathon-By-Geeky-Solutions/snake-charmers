...
def test_update_trip_status_success(client):
...
def test_update_status_trip_not_found(client):
    request_data = {
...
def test_update_status_invalid_trip_id(client):
    request_data = {
...
def test_update_status_invalid_status_value(client):
    request_data = {
        "trip_id": 1,
